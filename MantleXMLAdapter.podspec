Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/mbaranowski/MantleXMLAdapter.git", :tag => '0.1.0' }
  s.source_files = 'MTLXMLAdapter.{h,m}', 'NSValueTransformer+MTLXMLTransformerAdditions.{h,m}'
